...
|Stel en schakel een externe service in waarmee u bankafschriften direct kunt importeren als bankfeeds.|[Procedure: Conversieservice voor bankgegevens instellen](bank-how-setup-bank-data-conversion-service.md)|  
|Bankrekeningen koppelen in [!INCLUDE[d365fin](includes/d365fin_md.md)] als de bankgegevensconversieservice is ingeschakeld|[Procedure: bankrekeningen instellen](bank-how-setup-bank-accounts.md)|  
