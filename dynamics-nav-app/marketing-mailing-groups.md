...
## <a name="define-a-mailing-group-code"></a>Een mailinggroepscode definiëren
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport**, voer **Mailinggroepen** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="assign-mailing-groups-to-a-contact"></a>Mailinggroepen aan een contact toewijzen
1. Open het contact.
...
Het aantal mailinggroepen dat u aan het contact hebt toegewezen, wordt weergegeven in het veld **Aantal mailinggroepen** van het gedeelte **Segmentatie** van het venster **Contact**.
