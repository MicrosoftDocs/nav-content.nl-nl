...
## <a name="define-a-web-source-code"></a>Een webbroncode definiëren
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport**, voer **Webbronnen** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="assign-web-sources-to-a-contact-company"></a>Webbronnen toewijzen aan een contactbedrijf
