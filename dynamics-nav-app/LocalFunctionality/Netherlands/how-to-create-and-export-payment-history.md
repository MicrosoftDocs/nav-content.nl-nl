...
---
# <a name="how-to-create-and-export-payment-history"></a>Procedure: Betalingsrun maken en exporteren
Nadat u een voorstel hebt gemaakt en eventuele wijzigingen hebt aangebracht, kunt u het voorstel verwerken om een betaalrun te maken. Voorstellen kunnen handmatig worden gegenereerd of automatisch op basis van een leveranciers- of klantenpost. Zie [Procedure: Voorstellen maken](how-to-create-proposals.md) voor meer informatie.  
