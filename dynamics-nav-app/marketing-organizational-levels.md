...
## <a name="define-an-organizational-level-code"></a>Een organisatieniveaucode definiëren
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport**, voer **Organisatieniveaus** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="assign-organizational-levels-to-a-contact-person"></a>Organisatieniveaus toewijzen aan een contactpersoon
